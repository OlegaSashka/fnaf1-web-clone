...
3. Нажмите на кнопку **Go Live** в правом нижнем углу статус-бара VS Code. Проект автоматически откроется в браузере по адресу `http://127.0.0.1:5500/index.html`.
...
4. Нажмите на адресную строку в верхней части браузера, введите адрес http://localhost:3000/ и нажмите Enter для инициализации игры.
...
2. Не закрывайте окно терминала — это приведет к мгновенному отключению сервера. Сверните его.
3. Откройте веб-браузер.
4. Нажмите на адресную строку в верхней части браузера, введите адрес http://localhost:8000/ и нажмите Enter для запуска игрового процесса.